-- Fix: RETURNS TABLE output param names must not match columns used in the function body
-- (id, order_id, user_id, status, currency, created_at).
--
-- Changing OUT/return row type requires DROP; CREATE OR REPLACE alone raises 42P13.
